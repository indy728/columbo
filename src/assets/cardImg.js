...
const clubs = {
    ace: require(`./cardImg/clubs/ace.png`),
    jack: require(`./cardImg/clubs/jack.png`),
    queen: require(`./cardImg/clubs/queen.png`),
    king: require(`./cardImg/clubs/king.png`),
...
const spades = {
    ace: require(`./cardImg/spades/ace.png`),
    jack: require(`./cardImg/spades/jack.png`),
    queen: require(`./cardImg/spades/queen.png`),
    king: require(`./cardImg/spades/king.png`),
...
const hearts = {
    ace: require(`./cardImg/hearts/ace.png`),
    jack: require(`./cardImg/hearts/jack.png`),
    queen: require(`./cardImg/hearts/queen.png`),
    king: require(`./cardImg/hearts/king.png`),
...
const diamonds = {
    ace: require(`./cardImg/diamonds/ace.png`),
    jack: require(`./cardImg/diamonds/jack.png`),
    queen: require(`./cardImg/diamonds/queen.png`),
    king: require(`./cardImg/diamonds/king.png`),
